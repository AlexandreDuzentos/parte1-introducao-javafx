...
/* 
 * A classe constraints será a responsável por aplicar restrições nos
 * controles do tipo TextField.
 * */
public class Constraints {
   
	
	/* Método responsável por restrigir outros tipos de
	 * de valores para o TextField diferentes de Integer.
	 * */
	public static void setTextFieldInteger(TextField text) {
		/* Aqui basicamente eu estou adicionando um listener ao texto
		 * sendo digitado dentro o campo do tipo TextField que irá
		 * observar ou monitar modificações num campo do tipo TextField
		 ...
		 * */
		 text.textProperty().addListener((obs, oldValue, newValue) -> {
			 if(newValue != null && !newValue.matches("\\d*")) {
				 /* Um valor novo é apenas setado dentro do campo do tipo
				  * TextField se a condição acima for atendida, caso
				  * contrário o valor antigo permanece, e o valor antigo pode
				  * ser inclusível null */
